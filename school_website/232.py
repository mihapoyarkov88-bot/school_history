...
<div class="halls-nav">
    <div class="container">
        <div class="tabs" id="tabsContainer">
            ...
            <button class="tab-btn" data-hall="memoryHall">⭐ Галерея памяти (скоро)</button>
        </div>
    </div>
</div>
...
<main class="container">
    ...
    <div id="memoryHall" class="hall">
        <div style="background: white; border-radius: 32px; padding: 2rem; border: 1px solid #e9e2d8;">
            <h3 style="font-family: 'Playfair Display'; font-size: 2rem; color:#2a4a35;">⭐ Галерея памяти</h3>
            <p style="margin-bottom: 1.5rem;">Мы собираем архивные фотографии, воспоминания ветеранов педагогического труда и выпускников. Если у вас есть материалы – присылайте в школьный музей.</p>
            <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: center;">
                <div class="photo-placeholder" style="min-width: 180px;"><i>🎓</i> Выпуск 1949 года<br><span class="photo-caption">заглушка</span></div>
                <div class="photo-placeholder" style="min-width: 180px;"><i>📜</i> Пионерская линейка, 50-е<br><span class="photo-caption">ожидает оцифровки</span></div>
                <div class="photo-placeholder" style="min-width: 180px;"><i>🏫</i> Современное здание<br><span class="photo-caption">архив 2025</span></div>
            </div>
        </div>
    </div>
</main>
